...
INSERT INTO `command` VALUES ('account create',4,'Syntax: .account create $username $password\r\n\r\nCreate an account with given $username and $password.');
INSERT INTO `command` VALUES ('account delete',4,'Syntax: .account delete $username\r\n\r\nDelete the account with given $username.');
...
INSERT INTO `command` VALUES ('delticket',2,'Syntax: .delticket all        .delticket #num        .delticket $character_nameall to dalete all tickets at server, $character_name to delete ticket of this character, #num to delete ticket #num.');
...
INSERT INTO `command` VALUES ('goname',1,'Syntax: .goname [$charactername]Teleport to the given character. Either specify the character name or click on the character\'s portrait, e.g. when you are in a group. Character can be offline.');
...
INSERT INTO `command` VALUES ('honor show',2,'Syntax: .honor showDisplay the honor stats of the selected player');
...
INSERT INTO `command` VALUES ('namego',1,'Syntax: .namego [$charactername]Teleport the given character to you. Character can be offline.');
...
INSERT INTO `command` VALUES ('npc addmove',2,'Syntax: .npc addmove #creature_guid [#waittime]Add your current location as a waypoint for creature with guid #creature_guid. And optional add wait time.');
...
INSERT INTO `command` VALUES ('wp modify',2,'Syntax: .wp modify [#creature_guid or Select a Creature]add - Add a waypoint after the selected visualwaittime $timeemote IDspell IDtext1| text2| text3| text4| text5 <text>model1 IDmodel2 IDmove(moves wp to player pos)del (deletes the wp)Only one parameter per time!');
